...
namespace Dao
{
    public class DaoMedicos
    {
        ...
        public void ModUsuarioTablaMedico(string UsuarioViejo, string usuarioNuevo){


            string consulta = "update  Medicos Set Usuario_MED = '" + usuarioNuevo + "'" + " where Usuario_MED = '" + UsuarioViejo + "'";
