...
namespace Vistas
{
    public partial class ModificarMeidco : System.Web.UI.Page
    {
        ...
        protected void btnModificarUsuario_Click(object sender, EventArgs e)
        {
            ...
            string usuarioViejo = LblUsuarioLogueado.Text.ToString();
            if (UsuarioNuevo == Usuario2)
            {
                ...
                if (estado)
                {
                    ...
                    Session["Datos Usuario"] = UsuarioNuevo;
                    LblUsuarioLogueado.Text = Session["Datos Usuario"].ToString();
                }
                else
                {
            ...
            NM.ModificarUsuarioTablaMedico(usuarioViejo,UsuarioNuevo);//Modifica usuario en tabla Medico
